...
export default class ResetPassword extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            token: String.IsNullOrWhiteSpace(string),
    ...
    checkToken(email, token) {
        ...
        let url = `https://talentservicesidentity.azurewebsites.net/authentication/authentication/verifyResetPasswordToken?o=${email}&p=${token}`;
        $.ajax({
            url: url,
            type: 'POST',
    ...
    savePassword() {
        ...
        let resetUrl = `https://talentservicesidentity.azurewebsites.net/authentication/authentication/resetpassword?o=${email}&p=${token}`;
